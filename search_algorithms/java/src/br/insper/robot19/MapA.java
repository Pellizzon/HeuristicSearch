...
public class MapA {
     ...
     */
    public MapA(GridMap g, int width, int height) {
        this.map = g;
        this.width = width;
        this.height = height;
    ...
    public static void main(String[] args) {
         ...
         */
        MapA fig = new MapA(map);
        fig.draw();
        fig.saveFile("A-Star_Search.png");
